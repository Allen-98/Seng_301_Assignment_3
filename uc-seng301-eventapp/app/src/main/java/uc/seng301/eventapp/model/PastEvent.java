...
/**
 * This class represents an event that happened in the past. Can be rescheduled
 * or archived.
 */
@Entity
@DiscriminatorValue("PAST")
public class PastEvent extends Event {
   ...
   * Copy constructor.
   * 
   * @param event the event to copy into this new past event
   */
