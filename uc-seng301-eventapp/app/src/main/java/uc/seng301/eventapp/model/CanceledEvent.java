...
/**
 * This class represents a canceled event. Can be rescheduled or archived.
 */
@Entity
@DiscriminatorValue("CANCELED")
public class CanceledEvent extends Event {
   ...
   * Copy constructor.
   * 
   * @param event the event to copy into this new canceled event
   */
  ...
  public CanceledEvent cancel() {
    System.out.println("Can not cancel a canceled event");
    return this;
  }

  @Override
  public PastEvent happen() {
    System.out.println("A canceled event can not happen");
    return null;
  }
  ...
  public String toString() {
    return "CANCELED " + super.toString();
  }
}
